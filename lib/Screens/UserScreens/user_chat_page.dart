...
// Function to upload photos to Firebase Storage
  Future<void> uploadPhotos() async {
    ...
    if (selectedPhotos != null && selectedPhotos.length >= 2) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select at least 10 photos.'),
        ...
        child: Column(
          ...
          children: [
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: const Color(0xFFa2d19f), // background color
                                ),
                                child: const Text("Upload Photos"),
                              ),
                            ],
            ...
            if (isTourGroupActive && currentTourVerified)
              GestureDetector(
                onTap: () {
                  // Add functionality to track tour here
                },
                child: const Card(
                  color: Colors.white,
                  elevation: 3,
  ...
  Widget _buildDisabledCard(String title) {
    return Card(
      color: Colors.grey.shade300, // Disable color
      elevation: 3,
      child: ListTile(
        contentPadding: const EdgeInsets.all(16),
        leading: const Icon(Icons.block), // Icon to indicate disabled state
        title: Text(
          title,
          style: TextStyle(
            color: Colors.grey.shade600, // Text color for disabled state
            fontWeight: FontWeight.bold,
          ),
        ),
      ),
